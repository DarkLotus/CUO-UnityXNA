...
namespace ClassicUO
{
    ...
    internal class Engine : Microsoft.Xna.Framework.Game
    {
        ...
        private Engine(string[] args)
        {
            ...
            _settings = ConfigurationResolver.Load<Settings>(Path.Combine( "/media/james/480gb/ClassicUO/bin/Debug", "settings.json"));
        ...
        protected void BeginRun()
        {
            ...
            _previous = 0;//SDL.SDL_GetTicks();
        }

  
        public void Tick(uint t)
        {
            if (Profiler.InContext("OutOfContext"))
                Profiler.ExitContext("OutOfContext");


            double current = Ticks = t;
